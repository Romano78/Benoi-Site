    ...
    <Reveal effect="fadeInUp">
      <ProjetContainer className="test">
        <WidthLimiterContainer>
          {query?.page2 ? <Projet_Sec_1 querySection1={query.page2} /> : ""}
          {query?.page3 && query?.page3 ? (
            <Projet_Sec_2
          ...
          {query?.page14 && query?.page15 && query?.page16 ? (
            <Projet_Sec_6
